# Generated by Django 2.1.1 on 2019-07-29 09:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Buyer.Buyer', verbose_name='订单编号（多对一')),
            ],
        ),
        migrations.AddField(
            model_name='address',
